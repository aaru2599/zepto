  ...
  return (
    <div className="relative    ">
      ...
      <div className="bg-[#f5f1f7]">
        <div className=" border-b border-grey  p-2 font-bold shadow  md:hidden block">
        ...
        <div className="flex justify-center " style={{ height: "100vh" }}>
          ...
          >
            ...
            <div
              className="flex flex-col   w-[81%] overflow-scroll scrollable-data"
              // style={{ height: "100vh" }}
            >
              ...
              <div className="hidden md:block text-[1.5rem]  font-semibold tracking-[0.05rem] ">
                Buy Fresh Fruits Online
              </div>
